...
class CustomTrayMenu {
  ...
  _initTray() {
    ...
    process.emit('log', 'tray icon working now?!');
  }
  ...
  _initMenuWindow() {
    ...
    // add class to new window's body to apply platform specific css, you in case maclocker comes around...
  ...
  // called when I click on tray icon
  ...
  translate(pos) {
    ...
    if (process.platform == 'darwin') {
      ...
      // ffs windows... fine just move it 5px up
